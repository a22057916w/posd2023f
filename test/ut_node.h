...
TEST_F(NodeTest, find_a_file) {
    Node * result = home->find("./test/Users/user/home/Documents/favorites/cqrs.pdf");
    ASSERT_EQ(cqrs, result);
}

TEST_F(NodeTest, find_a_file_not_exist) {
    Node * result = home->find("./test/Users/user/home/Documents/favorites/helloworld.pdf");
    ASSERT_EQ(nullptr, result);
}

TEST_F(NodeTest, find_a_folder) {
    Node * result = document->find("./test/Users/user/home/Documents/favorites");
    ASSERT_EQ(favorite, result);
}

TEST_F(NodeTest, find_a_folder_not_exist) {
    Node * result = document->find("./test/Users/user/home/Documents/not_like");
    ASSERT_EQ(nullptr, result);
}

TEST_F(NodeTest, delete_a_file) {
    ASSERT_EQ(cqrs->name(), home->find("./test/Users/user/home/Documents/favorites/cqrs.pdf")->name());
    home->remove("./test/Users/user/home/Documents/favorites/cqrs.pdf");
    ASSERT_EQ(nullptr, home->find("./test/Users/user/home/Documents/favorites/cqrs.pdf"));
}

TEST_F(NodeTest, delete_a_folder) {
    ASSERT_EQ(favorite->name(), home->find("./test/Users/user/home/Documents/favorites")->name());
    home->remove("./test/Users/user/home/Documents/favorites");
    ASSERT_EQ(nullptr, home->find("./test/Users/user/home/Documents/favorites"));
}
