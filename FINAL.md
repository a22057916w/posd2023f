### 1. <br> This problem is about *composition* and *inheritance*.
  ...
  *False*, the object adapter is more flexible than the class adapter. <br> 
  ...
  pointer) to combine the adapted. <br>
  If there is a subclass of the adapted, the object adapter will work well with that, while the class adapter will have no access to it. 
